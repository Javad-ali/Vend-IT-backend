            ...
            PhoneOnlyPayload: {
                ...
                properties: {
                    ...
                    email: {
                        type: 'string',
                        format: 'email',
                        description: 'Optional placeholder email (actual email can be added later via profile API)'
                    },
    ...
    paths: {
        ...
        '/auth/register': {
            post: {
                ...
                requestBody: {
                    required: true,
                    content: { 'application/json': { schema: { $ref: '#/components/schemas/PhoneOnlyPayload' } } }
                },
                responses: {
                    200: {
        ...
        '/auth/resend': {
            post: {
                ...
                security: [{ BearerAuth: [] }],
                requestBody: {
                    content: { 'application/json': { schema: { $ref: '#/components/schemas/ResendOtpPayload' } } }
                },
                responses: {
                    200: {
        ...
        '/users/create-profile': {
            post: {
                ...
                requestBody: {
                    required: true,
                    content: { 'application/json': { schema: { $ref: '#/components/schemas/EditProfilePayload' } } }
                },
        ...
        '/users/edit-profile': {
            put: {
                ...
                security: [{ BearerAuth: [] }],
                requestBody: {
                    content: { 'multipart/form-data': { schema: { $ref: '#/components/schemas/EditProfilePayload' } } }
                },
        ...
        '/machines/{machineId}': {
            get: {
                ...
                responses: {
                    200: { description: 'Machine payload', content: { 'application/json': { schema: { $ref: '#/components/schemas/Machine' } } } },
        ...
        '/cart': {
            ...
            post: {
                ...
                tags: ['Cart'],
                security: [{ BearerAuth: [] }],
                requestBody: { content: { 'application/json': { schema: { $ref: '#/components/schemas/CartItemPayload' } } } },
        ...
        '/payments/cards': {
            get: { summary: 'List cards', tags: ['Payments'], security: [{ BearerAuth: [] }], responses: { 200: { description: 'Cards array' } } },
            post: { summary: 'Save card', tags: ['Payments'], security: [{ BearerAuth: [] }], responses: { 201: { description: 'Card created' } } }
        },
        ...
        '/payments/wallet/charge': {
            post: {
                ...
                tags: ['Payments'],
                security: [{ BearerAuth: [] }],
                requestBody: { content: { 'application/json': { schema: { $ref: '#/components/schemas/WalletChargePayload' } } } },
        ...
        '/payments/wallet/pay': {
            post: {
                ...
                tags: ['Payments'],
                security: [{ BearerAuth: [] }],
                requestBody: { content: { 'application/json': { schema: { $ref: '#/components/schemas/WalletPayPayload' } } } },
        ...
        '/payments/card/pay': {
            post: {
                ...
                tags: ['Payments'],
                security: [{ BearerAuth: [] }],
                requestBody: { content: { 'application/json': { schema: { $ref: '#/components/schemas/CardPayPayload' } } } },
        ...
        '/payments/history': {
            get: { summary: 'Payment history', tags: ['Payments'], security: [{ BearerAuth: [] }], responses: { 200: { description: 'History list' } } }
        },
        '/payments/wallet/history': {
            get: { summary: 'Wallet history', tags: ['Payments'], security: [{ BearerAuth: [] }], responses: { 200: { description: 'History list' } } }
        },
        '/payments/orders/history': {
            get: { summary: 'Order history', tags: ['Payments'], security: [{ BearerAuth: [] }], responses: { 200: { description: 'History list' } } }
        },
        '/payments/loyalty/history': {
            get: { summary: 'Loyalty history', tags: ['Payments'], security: [{ BearerAuth: [] }], responses: { 200: { description: 'History list' } } }
        },
        '/payments/dispense': {
            post: {
        ...
        '/content/contact': {
            post: {
                ...
                tags: ['Content'],
                security: [{ BearerAuth: [] }],
                requestBody: { content: { 'application/json': { schema: { $ref: '#/components/schemas/ContactPayload' } } } },
        ...
        '/feedback/ratings': {
            ...
            post: {
                ...
                tags: ['Feedback'],
                security: [{ BearerAuth: [] }],
                requestBody: { content: { 'application/json': { schema: { $ref: '#/components/schemas/RatingPayload' } } } },
        ...
        '/notifications': {
            ...
            post: {
                ...
                tags: ['Notifications'],
                security: [{ BearerAuth: [] }],
                requestBody: { content: { 'application/json': { schema: { $ref: '#/components/schemas/NotificationPayload' } } } },
