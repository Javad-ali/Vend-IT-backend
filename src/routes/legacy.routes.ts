...
import { handleCategories, handleLegacyProductImage, handleProducts, handleSearchProducts } from '../modules/products/products.controller.js';
import { handleListMachines, handleTriggerDispense } from '../modules/machines/machines.controller.js';
import { handleCreateCard, handleCardPayment, handleChargeWallet, handleDeleteCard, handleDispenseUpdate, handleGPayPayment, handleGPayToken, handleIosPayment, handleListCards, handleLoyaltyHistory, handleLoyaltyConversion, handleOrderHistory, handlePaymentHistory, handleWalletHistory, handleWalletPayment } from '../modules/payments/payments.controller.js';
...
router.get('/users/category/list', requireAuth, normalizeMachineIdQuery, (req, res) => handleCategories(req, res));
router.get('/users/product/list', requireAuth, normalizeMachineIdQuery, (req, res) => handleProducts(req, res));
router.get('/users/search/product', requireAuth, normalizeMachineIdQuery, (req, res) => handleSearchProducts(req, res));
...
router.get('/payments/loyality-point/history', requireAuth, handleLoyaltyHistory);
router.get('/payments/loyality-point/convert', requireAuth, handleLoyaltyConversion);
